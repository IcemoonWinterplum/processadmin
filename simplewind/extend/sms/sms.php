...
class Sms
{
    ...
    {
        $this->access_id     = 'LTAIdN5m3bbS5L6D';
        $this->access_key    = 'RjJ4zVnyAdtpyRYnpQuHPfAS0yY3l5';
        $this->end_point     = 'http://1007895158802418.mns.cn-hangzhou.aliyuncs.com';
        $this->topic         = 'sms.topic-cn-hangzhou';
        $this->template_code = 'SMS_71335334';
        $this->sign_name     = '阿拉丁云图';
        $this->var1          = 'code';
    }
