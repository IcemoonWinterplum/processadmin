...
class PublicController extends AdminBaseController
{
    ...
    public function doLogin()
    {
        ...
        if (!empty($result) && $result['user_type'] == 1) {
            if (cmf_compare_password($pass, $result['user_pass'])) {
                ...
                /*登录后重定向地址*/
                $url = isset($_SESSION['USER_LOGIN_ADDRESS'])?$_SESSION['USER_LOGIN_ADDRESS']: url("admin/Index/index");
                if(ismobile()){
                    $tem = url("admin/sys/myorder");
                    $url = isset($_SESSION['USER_LOGIN_ADDRESS'])?$_SESSION['USER_LOGIN_ADDRESS']: $tem;
                }
                //$url = url("admin/sys/myorder");
    ...
    public function logout()
    {
        ...
        unset($_SESSION['USER_LOGIN_ADDRESS']);
